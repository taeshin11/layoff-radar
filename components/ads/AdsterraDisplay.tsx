...
export function AdsterraDisplay() {
  ...
  useEffect(() => {
    ...
    opt.textContent = `atOptions = { 'key': '29d34c8aee4529eade7984808eb04591', 'format': 'iframe', 'height': 90, 'width': 728, 'params': {} };`;
    ref.current.appendChild(opt);
    const invoke = document.createElement('script');
    invoke.src = 'https://www.highperformanceformat.com/29d34c8aee4529eade7984808eb04591/invoke.js';
